    ...
    return (
      ...
      >
        <div className="relative w-full h-80">
          ...
          />
          <span className="absolute top-2 right-2 bg-red-700 bg-opacity-70 text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
            {tipo}
          </span>
        </div>
          ...
          <AnimatePresence initial={false} custom={direction}>
            ...
            >
              ...
              <div className="w-full lg:w-1/2 flex flex-col overflow-hidden">
                ...
                {/* Área do botão, fixa no fundo */}
                <div className="p-6 flex-shrink-0 border-t border-slate-200">
                  <motion.button
                    onClick={onOpenForm}
                    className="w-full bg-red-700 text-white font-bold py-3 md:py-4 rounded-lg text-lg md:text-xl shadow-lg hover:bg-red-800 transition-colors"
